...
test_boost.bin: test.cpp *.hpp coroutine_boost.cpp
	$(CXX) -std=c++14 test.cpp coroutine_boost.cpp -lboost_context -o test_boost.bin

speedtest_boost.bin: test.cpp *.hpp coroutine_boost.cpp
	$(CXX) -std=c++14 -O2 speedtest.cpp coroutine_boost.cpp -lboost_context -o speedtest_boost.bin
